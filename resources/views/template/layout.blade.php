        ...
        <header class="absolute inset-x-0 top-0 bg-slate-600 mb-1 ">
            <nav class="flex items-center justify-between p-6 lg:px-8 " aria-label="Global">
                <div class="sm:fixed sm:top-0 sm:right-0 p-6 text-right z-10">
                    @auth
                        <a href="{{ route('user.seguidores') }}" class="font-semibold text-gray-300 hover:text-gray-900 dark:text-gray-200 dark:hover:text-white focus:outline focus:outline-2 focus:rounded-sm focus:outline-red-500">Seguidores</a>
